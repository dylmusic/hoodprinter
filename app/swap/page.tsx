...
// app isn't on) instead of a hand-rolled quote UI. That gets Relay's full
// any-token/any-chain interface, not locked to $PRINT as the destination —
// it just defaults to ETH -> $PRINT on Robinhood Chain on load. Collects a
// 0.85% HOODPrinter fee via Relay's native appFees mechanism on every swap,
// not just $PRINT ones (see components/SwapEmbed.tsx).
